...
and the popularity of Artifical Intelligence in modern society.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/ratio_stats-imageonline.co-merged(1).png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/ratio_comp-imageonline.co-merged.png}}
...
outputs varying between relatively small and relatively large. From
these plots, we can see that Artifical Intelligence, Computer Vision,
and Neural and Evolutionary Computing seem to be the largest subfields
in terms of growth.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/top4_comp.png}}
...
computational papers have been Artifical Intelligence, Computation and
Language (Natural Language Processing), and Computer Vision and Pattern
Recognition. Perhaps surprisingly, the Artifical Intelligence subfield
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/comp_preds.png}}
